...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.wheel_bg;//用来设置整个应用的背景色 vive
	private int wheelForeground = R.drawable.wheel_val; //用来设置前端选中的透明颜色 vive

	// Shadows drawables
	private GradientDrawable topShadow; //上面的渐变色
	private GradientDrawable bottomShadow;//下面遮罩的渐变色
	...
	protected void onDraw(Canvas canvas) {
		...
		if (drawShadows) drawShadows(canvas);//用来绘制遮罩层的
	}
	...
	private void buildViewForMeasuring() {
		...
		if (itemsLayout != null) {
			...
			createItemsLayout();// first : 一个LinearLayout作为总交互入口
		}
